         ...
         <div class="row">
            <div class="col-md-6 my-auto">
               <p class="definition "> <i class="fa fa-quote-left"></i>
                  ...
                  <a class="btn btn-outline-warning " target = "_blank" href="https://www.geeksforgeeks.org/bubble-sort/"> <i class="fa fa-link"></i> Know More </a>
               </p>
            </div>
            <div class="col-md-6">
         ...
         <div class="row">
            <div class="col-md-6 my-auto">
               <p class="definition "> <i class="fa fa-quote-left"></i>
                  ...
                  <a class="btn btn-outline-warning " target = "_blank" href="https://www.geeksforgeeks.org/selection-sort/"> <i class="fa fa-link"></i> Know More </a>
               </p>
            </div>
            <div class="col-md-6">
